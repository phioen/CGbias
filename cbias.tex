...
them have small Sersice index ($<3$). The CG bias of small galaxies
are positive and approximately propertional to the Sersic index.
%
...
average. The dashed lines are the fitting formular by
Eq.\ref{eq:fitcgb}.
%
\be
...
estimation for CG bias, but a subdivision of the galaxies is
necessary. The multi-band magnitudes, i.e. colour, which is correlated
...
\begin{table}
  \begin{tabular}{llll}
    ...
    \hline
    $0-0.4$   &187  &$-7.4\times10^{-4}$  &$0.012$\\
    $0.4-0.8$  &1415 &$-3.2\times10^{-4}$  &$0.011$\\
    $0.8-1.2$  &1116 &$-3.8\times10^{-4}$  &0.018\\
    $>1.2$  &245  &$-1.2\times10^{-3}$  &0.018\\
    \\
    $0-0.4$  &667  &$1.1\times10^{-3}$  &0.0034\\
    $0.4-0.8$ &513  &$7.9\times10^{-4}$  &0.0043\\
    $0.8-1.2$ &187  &$2.3\times10^{-3}$  &0.0058\\
    $>1.2$  &935  &$1.7\times10^{-3}$  &0.00068\\
    \hline
  \end{tabular}
