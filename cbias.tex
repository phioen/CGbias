...
noisy images. Therefore, in the following result for noise images, we
will perform the convolution to the NCG image instead of deconvolution
to the CG one. (In reality we perform additional tests using images
with SNR=15, and find the deconvolution does cause some numerical
problems)
%
...
\caption{Same as Fig.\ref{fig:biasofz50} but for images of SNR=15, and
  $???$ realizations at each redshift.}
\label{fig:biasofz15}
\end{figure}
