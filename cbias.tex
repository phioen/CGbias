...
($n>2.75$, elliptical galaxy) or small Sersic index (disk galaxy). The
solid lines show the bin average. One can see that the red galaxies
have large negative bias, while the disk galaxies have relative small
bias.
